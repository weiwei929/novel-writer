...
class ExportService {
     ...
     * 导出为ZIP压缩包
     */
    async exportToZip(data, fileName) {
        try {
     ...
     * 导出文集为ZIP
     */
    async exportCollectionToZip(data, fileName) {
        try {
            return new Promise((resolve, reject) => {
...
`;
     ...
     * 辅助方法：生成项目完整内容
     */
    generateProjectFullContent(project, chapters) {
     ...
     * 清理导出目录
     */
    async cleanupExports(maxAge = 24 * 60 * 60 * 1000) {
        try {
