...
router.put('/:id/metadata/:field', async (req, res) => {
    try {
        ...
        const response = createErrorResponse(ApiErrorCode.DATABASE_ERROR, error instanceof Error ? error.message : 'Failed to update chapter metadata');
        res.status(ErrorCodeToHttpStatus[ApiErrorCode.DATABASE_ERROR]).json(response);
    }
});
/**
...
router.get('/:id/metadata/:field/versions', async (req, res) => {
    try {
        ...
        const response = createErrorResponse(ApiErrorCode.DATABASE_ERROR, error instanceof Error ? error.message : 'Failed to fetch chapter metadata versions');
        res.status(ErrorCodeToHttpStatus[ApiErrorCode.DATABASE_ERROR]).json(response);
    }
});
/**
...
router.get('/:id/metadata/:field', async (req, res) => {
    try {
        ...
        const response = createErrorResponse(ApiErrorCode.DATABASE_ERROR, error instanceof Error ? error.message : 'Failed to fetch chapter metadata');
        res.status(ErrorCodeToHttpStatus[ApiErrorCode.DATABASE_ERROR]).json(response);
    }
});
/**
...
router.post('/:id/metadata/:field/save-version', async (req, res) => {
    try {
        ...
        const response = createErrorResponse(ApiErrorCode.DATABASE_ERROR, error instanceof Error ? error.message : 'Failed to save chapter metadata version');
        res.status(ErrorCodeToHttpStatus[ApiErrorCode.DATABASE_ERROR]).json(response);
    }
});
