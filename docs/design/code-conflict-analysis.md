...
| C-22 | `/shelf` 路由 | 与墓园语义冲突 | M3 | → `/graveyard` 重定向（原 v4.1 表内「C-19」项，重编号避免与上列冲突） |
...
| **M1-B** | 205~209 | 企划课 4 Tab + 墓园 + **关联 UI** | C-05, C-09, C-11, C-15, **C-20, C-21** | 4 Tab 链路不断；提案↔作品可跳转 |
