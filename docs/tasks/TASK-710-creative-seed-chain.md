...
| 1 | **[710-A](./TASK-710-A-dark-chain-removal.md)** | 拆暗链（**扩大版**：两条路径）**+ 地基两行** | backend | 小 | — | 📋 **完整卡已出 2026-07-28 · 待授权 · 下一枪** |
| 2 | **710-B** | 构思笔记 + 清理无消费者字段 | frontend(+1 行 backend) | 小 | — | ⏳ 待授权 |
| 2 | **710-D** | 来源归位（三块）+ 手记文案分岔 | frontend | 小 | — | ⏳ 待授权 |
...
**共同点**：六条里有四条（1、3、4、5）是**看了一半就下结论**。这与前任参谋长「从静态信息推断动态事实」是同一类错的变体——不是没看代码，是**看了但没看到底**。
